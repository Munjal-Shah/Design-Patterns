...
-----------------------------------------------------------------------
## Description: I've used stack data structure to store the insertion order of the data. Because the memory is managed default and we don't need to allocate memory by ourself. Even we don't need to free this memroy and even reading & writing to stack is very fast.
